...
if ($search_term != '') {
    ...
    $where_conditions[] = "(nama_kategori_alat LIKE ?)"; 
    $params[] = $search_like;
    $types .= "s";
...
$order_by_sql = " ORDER BY id_kategori_alat DESC LIMIT ? OFFSET ?"; 
    ...
    <div class="dashboard-container">
        ...
        <div class="table-card">
            <div class="table-header">
                <h2><i class="fas fa-tools"></i> Data Kategori Alat (Total: <?= $total_rows ?>)</h2>

                <form action="index.php" method="GET" class="search-group">
                    <input
                        type="text"
                        name="search"
                        id="searchKategoriAlat"
                        placeholder="Search..."
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <p>Data kategori alat tidak ditemukan<?php if ($search_term != '') echo " untuk pencarian '<b>" . htmlspecialchars($search_term) . "</b>'"; ?>.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php
