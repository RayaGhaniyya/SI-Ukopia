...
$stmt = $conn->prepare("SELECT * FROM kategori_alat WHERE id_kategori_alat = ?");
...
<div class="container">
    ...
    <div class="form-container">
        ...
        <form id="kategoriAlatUpdateForm">
            <!-- [UBAH] Name hidden input sesuai primary key -->
            <input type="hidden" name="id_kategori_alat" value="<?= $id_kategori ?>">

            <!-- [UBAH] Label, name, dan value sesuai field DB -->
            <label>Nama Kategori</label>
            <input type="text" name="nama_kategori_alat" maxlength="100" required
                value="<?= htmlspecialchars($data['nama_kategori_alat']) ?>"
