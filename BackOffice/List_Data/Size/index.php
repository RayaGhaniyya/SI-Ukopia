<?php
// Path koneksi TIDAK DIUBAH (sesuai permintaan)
...
if ($search_term != '') {
    ...
    $where_conditions[] = "(ukuran LIKE ?)"; // Cari di kolom 'ukuran'
    $params[] = $search_like;
    $types .= "s";
...
// 3. QUERY TOTAL DATA
$count_query = "SELECT COUNT(*) as total FROM size" . $where_sql;
...
// 4. QUERY AMBIL DATA
$order_by_sql = " ORDER BY id_size DESC LIMIT ? OFFSET ?"; // Order by asli
$data_query = "SELECT id_size, ukuran FROM size" . $where_sql . $order_by_sql;
    ...
    <div class="dashboard-container">
        ...
        <div class="table-card">
            <div class="table-header">
                <h2><i class="fas fa-list"></i> Data Size (Total: <?= $total_rows ?>)</h2>
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <p>Data size tidak ditemukan<?php if ($search_term != '') echo " untuk pencarian '<b>" . htmlspecialchars($search_term) . "</b>'"; ?>.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php
