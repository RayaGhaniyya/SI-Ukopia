...
$query = "SELECT id_kategori_menu, nama_kategori FROM kategori_menu ORDER BY id_kategori_menu DESC";
...
<div class="container">
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            ...
            <h1><i class="fas fa-tags"></i>Kategori Menu</h1>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <h2><i class="fas fa-utensils"></i> Data Kategori Menu</h2>
                <input type="text" id="searchKategoriMenu" placeholder="🔍 Cari kategori...">
            </div>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <p>Belum ada data kategori menu. Klik tombol <strong>Tambah</strong> untuk menambahkan.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
