...
<div class="container">
    ...
    <div class="form-container light">
        ...
        <form id="menuAddForm" action="process_add.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div>
                    ...
                    <input type="file" id="fileInput" name="gambar" accept="image/jpeg,image/jpg,image/png,image/webp" onchange="handleImagePreview(this)" style="display: none;" required>
                    <div id="imagePreview" onclick="triggerFileInput()"><span id="previewText">Klik untuk memilih gambar</span></div>
                    <button type="button" id="uploadButton" class="btn btn-info" onclick="triggerFileInput()" style="margin-top: 10px; width: 200px; max-width: 100%; display: block; margin-left: auto; margin-right: auto;">
