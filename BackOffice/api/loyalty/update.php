...
try {
    ...
    if ($is_first_review) {
        $update_sql .= ", status_pengisian = 'Selesai'"; 
    }
    ...
    $status_data = [
        ...
        "discount10_claim_date" => getClaimDate($conn, $uid_akun, 1), 
        "free_serve_claim_date" => getClaimDate($conn, $uid_akun, 2), 
        "free_tshirt_claim_date" => getClaimDate($conn, $uid_akun, 3), 
