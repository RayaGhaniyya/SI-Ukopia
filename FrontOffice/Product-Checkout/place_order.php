...
// Jika email kosong, pakai dummy agar midtrans tidak error
...
if (isset($_SESSION['checkout_mode']) && $_SESSION['checkout_mode'] === 'buy_now' && isset($_SESSION['buy_now_item'])) {
    ...
    $items_beli[] = [
        ...
        'quantity' => intval($qty),
        'name' => substr($row['nama_produk'], 0, 50) // Midtrans limit nama 50 char
    ];
...
$midtrans_order_id = "TRX-" . time() . "-" . rand(100, 999); // ID Unik Transaksi

// 5. Simpan ke Database & Minta Token Midtrans
