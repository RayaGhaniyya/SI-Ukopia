...
// Note: Approve juga tidak ada sort by price
...
<nav class="secondary-navbar">
    ...
    <div class="nav-center">
        <h2 class="logo-title">Ukopia Approve</h2>
    </div>
        ...
        <?php else: ?>
            <div class="search-state-container" style="margin-top: 0;">
                ...
                <div class="search-state-text">
                    ...
                    <a href="approve.php" class="btn-reset-search">Lihat Semua Produk</a>
                </div>
            </div>
        <?php endif;
        $stmt->close(); ?>
    ...
    <?php if (!empty($keyword) && $result_produk->num_rows > 0): ?>
        <div class="search-state-container">
            ...
            <div class="search-state-text">
                ...
                <a href="approve.php" class="btn-reset-search">Reset Pencarian</a>
            </div>
        </div>
    <?php endif; ?>
</main>
